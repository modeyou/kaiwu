...
class Config:
    ...
    CURRICULUM_EASY_PROMOTE_COMPLETED_RATE = 0.5
    CURRICULUM_MEDIUM_PROMOTE_STEPS = 600.0  # 700
    CURRICULUM_MEDIUM_PROMOTE_TREASURES = 2 # 3.5
    CURRICULUM_HARD_PROMOTE_TOTAL_SCORE = 900.0  # 1500
